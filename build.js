...
const config = {
  ...
  perdanaNotes: {
    Hafizah: [
      [0,3,4,'PI 6 BES (9.00–10.00)'],[0,10,11,'PI 4 BIJAK (12.20–1.20)'],
      [1,0,1,'TASMIK 4 BES (7.30–8.30)'],[1,3,4,'PI 3 BIJAK (9.00–10.00)'],[1,8,9,'TASMIK 4 BIJ (11.20–12.20)'],[1,10,11,'PI 6 BES (12.20–1.20)'],
      [2,3,4,'TASMIK 4 BES (9.00–10.00)'],[2,6,7,'PI 4 BIJAK (10.20–11.20)'],[2,8,9,'TASMIK 1 BIJ (11.20–12.20)'],
      [3,0,1,'PI 6 BES (7.30–8.30)'],[3,2,3,'PI 4 BIJAK (8.30–9.30)'],[3,8,9,'PI 3 BIJAK (11.20–12.20)'],
      [4,0,1,'TASMIK 2 BIJ (7.30–8.30)'],[4,7,8,'PI 3 BIJAK (10.50–11.50)'],
    ],
  },
  perdanaExtra: {
    Hafizah: [],
  ...
  perdanaView: {
    cols: [
      {start:'7.30',end:'8.00'},{start:'8.00',end:'8.30'},{start:'8.30',end:'9.00'},
      {start:'9.00',end:'9.30'},{start:'9.30',end:'9.50'},{start:'9.50',end:'10.20'},
      {start:'10.20',end:'10.50'},{start:'10.50',end:'11.20'},{start:'11.20',end:'11.50'},
      {start:'11.50',end:'12.20'},{start:'12.20',end:'12.50'},{start:'12.50',end:'1.20'}
    ],
    colOfIdx: [0,1,2,4,5,6,7,8,9,10,11],
    idxToggleOfCol: {0:0,1:1,2:2,3:3,4:3,5:4,6:5,7:6,8:7,9:8,10:9,11:10},
  },
};
