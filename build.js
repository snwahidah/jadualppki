...
const config = {
  ...
  perdanaNotes: {
    Hafizah: [
      [0,3,4,'PI 6 BES (9.00–10.00)'],
      [1,0,1,'TASMIK 4 BES (7.30–8.30)'],[1,3,4,'PI 3 BIJAK (9.00–10.00)'],[1,7,8,'TASMIK 4 BIJ (11.20–12.20)'],
  ...
  perdanaExtra: {
    Hafizah: ['Isnin 12.20–1.20: PI 4 BIJAK','Selasa 12.20–1.20: PI 6 BES'],
  },
};
